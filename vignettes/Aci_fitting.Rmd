...
In the first exemple, the parameter TpRef was not included in the list Start, so the TPU limitation was not included in the fitting. In this second example, we now add TpRef in the list Start so the TPU limitation is also evaluated.
